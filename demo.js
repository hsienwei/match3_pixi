  ...
  match3.m_CBMove = function (Col, Row, TargetCol, TargetRow, MoveType) {
    ...
    if (MoveType == 1) {
      ...
      if (GemB != null) {
        //GemB.x = Col * 70;
        //GemB.y = Row * 70;
        tweenTo(GemB, "x", Col * 70, match3.WAIT_UPDATE_TIME_UNIT, backout(0.6), null, null);
        tweenTo(GemB, "y", Row * 70, match3.WAIT_UPDATE_TIME_UNIT, backout(0.6), null, null);
      }

      if (GemA != null) {
        //GemA.x = TargetCol * 70;
        //GemA.y = TargetRow * 70;
        tweenTo(GemA, "x", TargetCol * 70, match3.WAIT_UPDATE_TIME_UNIT, backout(0.6), null, null);
        tweenTo(GemA, "y", TargetRow * 70, match3.WAIT_UPDATE_TIME_UNIT, backout(0.6), null, null);
      }
